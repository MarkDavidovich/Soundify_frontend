...
export function MainViewFooter() {
        ...
        <section className="main-view-footer">
            <div className="details-container">
                <div className="info flex">
                    ...
                    <section className="soundify-plans">
                        <h4>Soundify Plans</h4>
                        <span>Support</span>
                        <span>Free Mobile App</span>
                    </section>
